...
drop table if exists dbo.PlayerOverallStatistics;
GO
...
BEGIN
    ...
    (
        ...
        AnnualOperatingCost     DECIMAL(18,4) NOT NULL CONSTRAINT DF_Stadium_AnnualOperatingCost DEFAULT (0.0000),
...
BEGIN
    INSERT INTO dbo.Stadium (Name,City,Country,Capacity,OpenedDate,SurfaceType,RoofType,HomeTeamName,AnnualRevenue,AnnualOperatingCost,IsActive)
    VALUES
    ('Red Rock Arena','Phoenix','US',45000,CAST('1999-05-01' AS Date),'Grass','Open','Phoenix Rockers',12345678.90,245000.5000,1),
    ('Harbor Field','Seattle','US',38000,CAST('2001-07-12' AS Date),'Grass','Retractable','Seattle Harbors',9876543.21,198000.7500,1),
    ('Central Dome','Tokyo','JP',60000,CAST('2003-03-20' AS Date),'Synthetic','Retractable','Tokyo Titans',45200000.00,287500.2500,1),
    ('Maple Park','Toronto','CA',42000,CAST('1995-09-14' AS Date),'Grass','Open','Toronto Leafs',15800000.55,215000.0000,1),
    ('Granite Stadium','London','UK',50000,CAST('1988-06-01' AS Date),'Grass','Closed','London Granite',27450000.00,265000.5000,1),
    ('Oceanview Arena','San Diego','US',30000,CAST('2008-11-10' AS Date),'Grass','Open','San Diego Waves',8200000.75,175000.2500,1),
    ('Prairie Grounds','Winnipeg','CA',28000,CAST('1992-04-03' AS Date),'Synthetic','Open','Prairie Pioneers',4100000.00,165000.0000,1),
    ('Empire Field','New York','US',62000,CAST('2010-09-22' AS Date),'Grass','Retractable','New York Empire',67234000.10,299500.7500,1),
    ('Blue Ridge Park','Atlanta','US',36000,CAST('2000-08-15' AS Date),'Grass','Open','Atlanta Blue',9400000.00,192000.5000,1),
    ('Riverside Coliseum','Portland','US',27000,CAST('1997-10-05' AS Date),'Synthetic','Open','Portland Rivercats',3300000.20,158000.2500,1),
    ('Stadium Verde','Mexico City','MX',48000,CAST('1994-09-10' AS Date),'Grass','Open','Mexico Verde',11200000.00,235000.0000,1),
    ('Harbourfront Dome','Vancouver','CA',35000,CAST('2005-05-06' AS Date),'Synthetic','Retractable','Vancouver Vibe',6050000.40,188000.7500,1),
    ('Liberty Arena','Boston','US',41000,CAST('1985-06-20' AS Date),'Grass','Closed','Boston Liberty',14230000.00,212000.5000,1),
    ('Continental Park','Chicago','US',54000,CAST('1990-04-12' AS Date),'Grass','Open','Chicago Continentals',30560000.90,272000.2500,1),
    ('Sunset Bowl','Los Angeles','US',72000,CAST('2015-02-28' AS Date),'Grass','Retractable','LA Sunsets',88500000.00,298000.0000,1),
    ('Harbor Stadium','Barcelona','ES',46000,CAST('1998-03-17' AS Date),'Grass','Open','Barcelona Mariners',20120000.00,228000.7500,1),
    ('Stonebridge Park','Melbourne','AU',33000,CAST('2002-11-02' AS Date),'Grass','Open','Melbourne Strikers',7200000.95,182000.5000,1),
    ('Northgate Arena','Edinburgh','UK',29000,CAST('1996-09-30' AS Date),'Grass','Closed','Edinburgh North',3150000.00,168000.2500,1),
    ('Valley Field','Denver','US',39000,CAST('1989-07-09' AS Date),'Grass','Open','Denver Valleys',6900000.00,205000.0000,1),
    ('Cascade Dome','Oakland','US',25000,CAST('2004-05-20' AS Date),'Synthetic','Open','Oakland Cascades',2450000.50,148000.7500,1),
    ('Copper Bowl','Salt Lake City','US',31000,CAST('1993-08-18' AS Date),'Grass','Open','SLC Copperheads',2980000.00,178000.5000,1),
    ('Metro Stadium','Paris','FR',52000,CAST('1987-06-12' AS Date),'Grass','Closed','Paris Metros',22345000.00,268000.2500,1),
    ('Harbor Lights Park','Miami','US',29000,CAST('2006-11-01' AS Date),'Grass','Open','Miami Lights',8700000.00,169000.0000,1),
    ('Ironworks Arena','Pittsburgh','US',31000,CAST('1991-10-10' AS Date),'Grass','Closed','Pittsburgh Irons',4100000.00,179000.7500,1),
    ('Palace Field','Lisbon','PT',34000,CAST('2007-04-04' AS Date),'Grass','Retractable','Lisbon Royals',5500000.00,185000.5000,1),
    ('Beacon Stadium','Columbus','US',37000,CAST('1994-09-27' AS Date),'Grass','Open','Columbus Beacons',3600000.45,195000.2500,1),
    ('Harbour Gate','Oslo','NO',26000,CAST('2000-12-12' AS Date),'Synthetic','Closed','Oslo Gatekeepers',2100000.00,152000.0000,1),
    ('Liberty Field','Philadelphia','US',48000,CAST('1986-05-23' AS Date),'Grass','Open','Philly Liberty',12900000.00,238000.7500,1),
    ('Crystal Park','Singapore','SG',20000,CAST('2012-03-30' AS Date),'Synthetic','Retractable','SG Crystals',9700000.00,125000.5000,1),
    ('Harborview Stadium','Housto','US',44000,CAST('1998-09-18' AS Date),'Grass','Open','Houston Harbor',15000000.00,222000.2500,1),
    ('Praxis Arena','Berlin','DE',47000,CAST('2001-07-07' AS Date),'Grass','Retractable','Berlin Praxis',18120000.00,232000.0000,1),
    ('Kings Meadow','Manchester','UK',36000,CAST('1999-08-21' AS Date),'Grass','Closed','Manchester Kings',9400000.00,193000.7500,1),
    ('Gulfstream Park','Abu Dhabi','AE',28000,CAST('2013-11-11' AS Date),'Synthetic','Retractable','Abu Gulfstream',13200000.00,162000.5000,1),
    ('Stadium Azul','Buenos Aires','AR',52000,CAST('1984-06-30' AS Date),'Grass','Open','Buenos Azuls',19450000.00,267000.2500,1),
    ('Northern Lights Dome','Reykjavik','IS',18000,CAST('2009-02-14' AS Date),'Synthetic','Closed','Icebreakers',950000.00,115000.0000,1),
    ('Kingsford Stadium','Sydney','AU',61000,CAST('2016-05-05' AS Date),'Grass','Retractable','Sydney Kings',56200000.00,295000.7500,1),
    ('Citadel Park','Barcelona','ES',34000,CAST('1992-09-09' AS Date),'Grass','Open','Catalan Citadels',7200000.00,186000.5000,1),
    ('Riverbank Arena','Prague','CZ',24000,CAST('1997-03-03' AS Date),'Grass','Closed','Prague River',1850000.00,142000.2500,1),
    ('Eagle Nest','Charlotte','US',33000,CAST('2000-10-20' AS Date),'Grass','Open','Charlotte Eagles',4050000.00,183000.0000,1),
    ('Liberty Ridge','Stanford','US',15000,CAST('2018-08-08' AS Date),'Synthetic','Open','Stanford Rams',980000.00,108000.7500,1),
    ('Bayfront Stadium','Naples','IT',29000,CAST('1991-06-06' AS Date),'Grass','Closed','Naples Bay',2400000.00,170000.5000,1),
    ('Victory Field','Indianapolis','US',25000,CAST('1995-09-01' AS Date),'Grass','Open','Indy Victors',1850000.25,147000.2500,1),
    ('Aurora Arena','Sofia','BG',22000,CAST('2006-10-10' AS Date),'Synthetic','Open','Sofia Auroras',1120000.00,135000.0000,1);
END
GO
...
BEGIN
    ...
    ('Ryan','M.','Martin','Rye',null,'Male','US',180,76,'Thrower',10,4,1),
    ...
    ('Elizabeth','R.','Clark','Liz',null,'Female','US',161,59,'Catcher',7,5,1),
    ...
    ('Matthew','G.','Carter','Mattie',null,'Male','US',180,78,'Thrower',11,9,1),
...
BEGIN
    ...
    (CAST('2025-09-01' AS date), CAST('2025-09-01T19:00:00' AS datetime2), 60, 20,11,10,11,10,'Completed',5,'Seeded match'),
    ...
    (CAST('2025-09-01' AS date), CAST('2025-09-01T19:00:00' AS datetime2), 60, 27,18,17,11,10,'Completed',5,'Seeded match'),
    ...
    (CAST('2025-09-02' AS date), CAST('2025-09-02T18:30:00' AS datetime2), 60, 20,11,10,10,9,'Completed',5,'Seeded match'),
    ...
    (CAST('2025-09-02' AS date), CAST('2025-09-02T18:30:00' AS datetime2), 60, 27,18,17,10,9,'Completed',5,'Seeded match'),
    ...
    (CAST('2025-09-03' AS date), CAST('2025-09-03T20:00:00' AS datetime2), 60, 20,11,10,12,11,'Completed',5,'Seeded match'),
    ...
    (CAST('2025-09-03' AS date), CAST('2025-09-03T20:00:00' AS datetime2), 60, 27,18,17,12,11,'Completed',5,'Seeded match'),
    ...
    (CAST('2025-09-04' AS date), CAST('2025-09-04T17:00:00' AS datetime2), 60, 20,11,10,11,10,'Completed',5,'Seeded match'),
    ...
    (CAST('2025-09-04' AS date), CAST('2025-09-04T17:00:00' AS datetime2), 60, 27,18,17,10,9,'Completed',5,'Seeded match'),
...
-- create the PlayerOverallStatistics table only if it doesn't already exist (idempotent)
IF OBJECT_ID('dbo.PlayerOverallStatistics','U') IS NULL
BEGIN
    CREATE TABLE dbo.PlayerOverallStatistics
    (
        PlayerId                INT NOT NULL CONSTRAINT PK_PlayerOverallStatistics PRIMARY KEY,
        GamesPlayed             INT NOT NULL CONSTRAINT DF_PlayerOverallStatistics_GamesPlayed DEFAULT (0),
        TotalThrows             INT NOT NULL CONSTRAINT DF_PlayerOverallStatistics_TotalThrows DEFAULT (0),
        SuccessfulHits          INT NOT NULL CONSTRAINT DF_PlayerOverallStatistics_SuccessfulHits DEFAULT (0),
        TotalCatches            INT NOT NULL CONSTRAINT DF_PlayerOverallStatistics_TotalCatches DEFAULT (0),
        TotalDodges             INT NOT NULL CONSTRAINT DF_PlayerOverallStatistics_TotalDodges DEFAULT (0),
        PlayersEliminated       INT NOT NULL CONSTRAINT DF_PlayerOverallStatistics_PlayersEliminated DEFAULT (0),
        TimesEliminated         INT NOT NULL CONSTRAINT DF_PlayerOverallStatistics_TimesEliminated DEFAULT (0),
        BallsPickedUp           INT NOT NULL CONSTRAINT DF_PlayerOverallStatistics_BallsPickedUp DEFAULT (0),
        AssistsProvided         INT NOT NULL CONSTRAINT DF_PlayerOverallStatistics_AssistsProvided DEFAULT (0),
        MinutesPlayed           INT NOT NULL CONSTRAINT DF_PlayerOverallStatistics_MinutesPlayed DEFAULT (0),
        TotalPoints             INT NOT NULL CONSTRAINT DF_PlayerOverallStatistics_TotalPoints DEFAULT (0),
        PowerThrowsAttempted    INT NOT NULL CONSTRAINT DF_PlayerOverallStatistics_PowerThrowsAttempted DEFAULT (0),
        PowerThrowsSuccessful   INT NOT NULL CONSTRAINT DF_PlayerOverallStatistics_PowerThrowsSuccessful DEFAULT (0),
        TeamSavingCatches       INT NOT NULL CONSTRAINT DF_PlayerOverallStatistics_TeamSavingCatches DEFAULT (0),
        FoulsCommitted          INT NOT NULL CONSTRAINT DF_PlayerOverallStatistics_FoulsCommitted DEFAULT (0),
        CreateDate              DATETIME2(0) NOT NULL CONSTRAINT DF_PlayerOverallStatistics_CreateDate DEFAULT (SYSUTCDATETIME()),
        CONSTRAINT FK_PlayerOverallStatistics_Player FOREIGN KEY (PlayerId) REFERENCES dbo.Player(Id)
    );
END
GO

-- Seed data for PlayerOverallStatistics table
IF NOT EXISTS (SELECT 1 FROM dbo.PlayerOverallStatistics)
BEGIN
    INSERT INTO dbo.PlayerOverallStatistics (PlayerId,GamesPlayed,TotalThrows,SuccessfulHits,TotalCatches,TotalDodges,PlayersEliminated,TimesEliminated,BallsPickedUp,AssistsProvided,MinutesPlayed,TotalPoints,PowerThrowsAttempted,PowerThrowsSuccessful,TeamSavingCatches,FoulsCommitted)
    VALUES
    (1,45,320,185,42,78,95,22,145,28,1620,425,45,28,12,8),
    (2,48,180,95,118,92,58,18,98,35,1728,385,22,11,38,5),
    (3,42,245,140,65,110,82,25,165,22,1512,360,35,20,18,12),
    (4,50,290,165,52,88,98,20,172,31,1800,415,40,25,15,7),
    (5,46,335,195,48,72,105,19,188,26,1656,445,50,32,10,9),
    (6,44,165,82,125,98,50,15,92,42,1584,370,18,9,42,4),
    (7,40,228,130,70,105,75,23,155,24,1440,345,32,18,20,10),
    (8,49,275,158,58,85,92,21,168,29,1764,405,38,23,16,8),
    (9,47,345,200,45,68,110,17,195,24,1692,465,52,34,9,11),
    (10,43,172,88,132,102,52,16,88,45,1548,380,20,10,45,3),
    (11,41,238,135,68,108,78,24,162,26,1476,355,33,19,19,11),
    (12,48,282,162,55,82,94,22,175,30,1728,410,39,24,14,9),
    (13,44,315,180,50,75,100,20,185,27,1584,430,46,29,11,10),
    (14,46,168,85,120,95,55,17,95,40,1656,375,19,10,40,5),
    (15,39,232,132,72,112,80,26,158,25,1404,350,34,20,21,12),
    (16,47,268,155,60,88,90,23,170,28,1692,400,37,22,17,8),
    (17,45,328,190,47,70,108,18,192,25,1620,440,49,31,10,10),
    (18,42,175,90,128,100,58,16,90,43,1512,385,21,11,43,4),
    (19,40,240,138,66,110,85,25,160,23,1440,360,35,21,18,11),
    (20,46,278,160,56,84,95,21,172,29,1656,405,38,23,15,9),
    (21,48,340,198,46,72,112,19,198,26,1728,450,51,33,11,11),
    (22,44,170,87,122,96,56,17,92,41,1584,380,20,10,41,5),
    (23,41,235,135,70,109,82,24,165,24,1476,358,34,20,20,10),
    (24,47,285,165,54,80,97,22,178,30,1692,412,40,25,14,8),
    (25,43,318,182,49,74,102,21,188,28,1548,432,47,30,12,9),
    (26,45,172,88,125,98,57,16,95,42,1620,378,21,11,42,4),
    (27,38,230,130,68,115,78,27,155,22,1368,345,32,18,19,13),
    (28,46,272,158,58,86,93,23,175,29,1656,408,38,23,16,9),
    (29,44,332,195,47,71,109,18,195,25,1584,445,50,32,10,10),
    (30,42,168,85,130,102,54,15,88,44,1512,375,19,9,44,3),
    (31,40,242,140,65,112,82,26,162,24,1440,355,35,21,18,12),
    (32,48,280,162,56,82,96,22,175,30,1728,410,39,24,15,8),
    (33,46,325,188,48,73,107,19,192,27,1656,438,48,31,11,10),
    (34,43,175,90,126,99,58,16,92,43,1548,382,21,11,43,4),
    (35,41,235,135,69,111,80,25,160,23,1476,352,34,20,20,11),
    (36,47,275,160,57,85,94,22,172,28,1692,405,38,23,16,9),
    (37,45,338,200,46,70,113,18,198,26,1620,452,52,34,10,11),
    (38,44,170,87,124,97,56,17,90,42,1584,378,20,10,42,5),
    (39,42,238,138,67,110,84,24,162,24,1512,358,35,21,19,10),
    (40,46,282,165,55,83,97,21,175,29,1656,412,40,25,14,8),
    (41,48,330,192,47,72,110,19,195,26,1728,445,50,32,11,10),
    (42,43,172,88,128,100,57,16,92,43,1548,380,21,11,43,4),
    (43,40,235,132,70,113,81,26,158,23,1440,350,33,19,20,12),
    (44,47,278,162,56,84,96,22,172,29,1692,410,39,24,15,9),
    (45,44,322,185,48,74,105,20,188,27,1584,432,46,29,12,10),
    (46,42,168,85,125,98,55,17,90,42,1512,375,19,9,42,5),
    (47,41,240,140,66,111,83,25,160,24,1476,355,35,21,18,11),
    (48,46,275,158,57,85,93,22,170,28,1656,405,38,23,16,8),
    (49,45,335,198,47,71,111,18,195,26,1620,448,51,33,10,11),
    (50,43,170,87,127,100,56,16,92,43,1548,378,20,10,43,4),
    (51,42,238,135,68,110,82,24,162,24,1512,355,34,20,19,10),
    (52,48,280,162,56,82,96,22,175,29,1728,410,39,24,15,8),
    (53,46,328,190,48,73,108,19,192,27,1656,440,49,31,11,10),
    (54,44,172,88,126,98,57,17,92,42,1584,380,21,11,42,4),
    (55,41,235,135,69,112,81,25,160,23,1476,352,34,20,20,11),
    (56,47,275,160,57,85,94,22,172,28,1692,405,38,23,16,9),
    (57,45,340,200,46,70,113,18,198,26,1620,450,52,34,10,11),
    (58,43,170,87,128,100,56,16,90,43,1548,378,20,10,43,5),
    (59,40,240,138,66,111,84,26,160,24,1440,355,35,21,18,12),
    (60,46,278,162,56,84,96,22,172,29,1656,410,39,24,15,9),
    (61,44,325,188,48,74,107,20,188,27,1584,435,48,30,12,10),
    (62,42,168,85,125,98,55,17,90,42,1512,375,19,9,42,5),
    (63,41,235,135,69,112,81,25,160,23,1476,352,34,20,20,11),
    (64,47,280,162,56,83,96,22,175,29,1692,410,39,24,15,8),
    (65,45,332,195,47,72,110,19,195,26,1620,445,50,32,11,10),
    (66,43,172,88,127,100,57,16,92,43,1548,380,21,11,43,4),
    (67,40,238,138,67,111,83,25,162,24,1440,355,35,21,19,11),
    (68,46,275,160,57,85,94,22,172,28,1656,405,38,23,16,9),
    (69,44,335,198,47,71,111,18,195,26,1584,448,51,33,10,11),
    (70,42,170,87,128,100,56,16,90,43,1512,378,20,10,43,5),
    (71,41,240,140,66,112,84,25,160,24,1476,358,35,21,18,11),
    (72,47,280,162,56,84,96,22,175,29,1692,410,39,24,15,9),
    (73,45,330,192,48,73,109,19,192,27,1620,442,50,32,11,10),
    (74,43,172,88,126,99,57,17,92,42,1548,380,21,11,42,4),
    (75,40,235,135,69,113,81,26,160,23,1440,352,34,20,20,12),
    (76,46,278,162,56,85,96,22,172,29,1656,410,39,24,15,9),
    (77,44,328,190,48,72,108,19,192,27,1584,440,49,31,11,10),
    (78,42,170,87,127,100,56,16,90,43,1512,378,20,10,43,5),
    (79,41,238,138,67,111,83,25,162,24,1476,355,35,21,19,11),
    (80,47,275,160,57,84,94,22,172,28,1692,405,38,23,16,9),
    (81,45,338,200,47,71,112,18,198,26,1620,450,52,34,10,11),
    (82,43,172,88,128,100,57,16,92,43,1548,380,21,11,43,4),
    (83,40,235,135,68,112,82,26,160,24,1440,352,34,20,19,12),
    (84,46,280,162,56,83,96,22,175,29,1656,410,39,24,15,8),
    (85,44,325,188,48,74,107,20,188,27,1584,435,48,30,12,10),
    (86,42,168,85,126,98,55,17,90,42,1512,375,19,9,42,5),
    (87,41,240,140,66,111,84,25,160,24,1476,355,35,21,18,11),
    (88,47,278,162,56,85,96,22,172,29,1692,410,39,24,15,9),
    (89,45,332,195,47,72,110,19,195,26,1620,445,50,32,11,10),
    (90,43,170,87,127,100,56,16,90,43,1548,378,20,10,43,5),
    (91,40,238,138,67,112,83,26,162,24,1440,355,35,21,19,12),
    (92,46,275,160,57,84,94,22,172,28,1656,405,38,23,16,9),
    (93,44,335,198,47,71,111,18,195,26,1584,448,51,33,10,11),
    (94,42,172,88,128,100,57,16,92,43,1512,380,21,11,43,4),
    (95,41,235,135,69,113,81,25,160,23,1476,352,34,20,20,11),
    (96,47,280,162,56,84,96,22,175,29,1692,410,39,24,15,9),
    (97,45,330,192,48,73,109,19,192,27,1620,442,50,32,11,10),
    (98,43,172,88,127,100,57,17,92,42,1548,380,21,11,42,4),
    (99,40,238,138,67,111,83,25,162,24,1440,355,35,21,19,11),
    (100,46,278,162,56,85,96,22,172,29,1656,410,39,24,15,9);
END
GO